  ...
  if (!isPaid) {
    return (
      <main className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-xl w-full bg-white rounded-3xl shadow-xl border border-red-100 p-10 text-center">
          <h1 className="text-3xl font-bold text-zinc-900">Payment not completed</h1>
          <p className="mt-4 text-zinc-600">
            We couldn't confirm your payment. If you were charged, please contact support.
          </p>
          <Link
            href="/books"
            className="mt-8 inline-block bg-zinc-900 text-white px-6 py-3 rounded-xl font-medium"
          >
            Back to Ebooks
          </Link>
        </div>
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 flex items-center justify-center px-4">
      <div className="max-w-xl w-full bg-white rounded-3xl shadow-xl border border-green-100 p-10 text-center">
        ...
        <h1 className="mt-6 text-3xl font-bold text-zinc-900">Payment Successful 🎉</h1>

        <p className="mt-4 text-zinc-600 leading-7">
          Thank you for purchasing your ebook. Your payment has been confirmed
          and the full content is now unlocked.
        </p>

        <div className="mt-6 bg-zinc-50 rounded-2xl p-4 border">
          <p className="text-sm text-zinc-500">Confirmation sent to</p>
          <p className="mt-1 font-semibold text-zinc-900">{buyerEmail}</p>
        </div>

        <div className="mt-6 flex items-center justify-center gap-2 text-green-700">
          <span className="w-2 h-2 bg-green-500 rounded-full"></span>
          <span className="font-medium">Ebook access has been unlocked</span>
        </div>
        ...
        <p className="mt-8 text-sm text-zinc-500">
          Need help? Contact our support team at{" "}
          <a href="mailto:support@ebook.com" className="text-primary font-medium hover:underline">
            support@ebook.com
          </a>
        </p>
      </div>
